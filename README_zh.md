...
**biopalette** 是一个 R 包，提供以图像为来源的故事驱动配色方案，专为生物医学可视化设计。
...
| 名称 | 类型 | 颜色数 | 来源 |
|---|---|---|---|
| [`gene_red`](palettes/gene_red) | 定性 | 2 | *风骚律师* — Gene Takavic 的红色外套 |
| [`walter_white`](palettes/walter_white) | 发散 | 5 | *绝命毒师* — 荒漠到天空 |
| [`walter_white2`](palettes/walter_white2) | 定性 | 5 | *绝命毒师* — 低饱和大地色调 |
