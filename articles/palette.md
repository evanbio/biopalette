...
create_palette("my_blues", "sequential", c("#deebf7", "#9ecae1", "#3182bd"),
               color_dir = temp_dir)
#> ✔ Palette saved: /tmp/Rtmpx3LdXc/palettes/sequential/my_blues.json

create_palette("my_trio", "qualitative",
               c("#E64B35", "#4DBBD5", "#00A087"),
               color_dir = temp_dir)
#> ✔ Palette saved: /tmp/Rtmpx3LdXc/palettes/qualitative/my_trio.json
```
...
create_palette("three_body_light", "qualitative", light_hex,
               color_dir = temp_dir)
#> ✔ Palette saved: /tmp/Rtmpx3LdXc/palettes/qualitative/three_body_light.json
