...
The **biopalette** package provides story-driven color palettes for
biomedical visualization, each sourced from a real image — a film still,
a scientific figure, or an artwork — and translated into a reproducible
color system.
